...
import "./profile.css";
import { isAuthenticated, getAuthUser, logoutUser } from "../Firebase";
      ...
      if (isAuthenticated()) {
        try {
          ...
          setUser({
            ...
            photoURL: userData.avatar || Default
          });
        } catch (error) {
            ...
            <div className="right-account-section">
              ...
              <div className="personal-user-data">
                ...
                <div className="personal-mail">
                  ...
                  <p className="users-mail">{user && user.email ? `${user.email.slice(0,15) + "..."}` : ""}</p>
                </div>
              </div>
            </div>
          </div>
