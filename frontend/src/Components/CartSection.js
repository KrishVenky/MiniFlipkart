...
function CartSection() {
  ...
  const [backendWishlist, setBackendWishlist] = useState(null);

  const navigate = useNavigate();

  document.title = "Cart section"

  // Fetch cart and wishlist from backend on mount
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setBackendWishlist(wishlistData);
        
        // Sync Redux with backend data
        // Note: Redux actions would need to be dispatched here if you want full sync
      } catch (error) {
            ...
            <div className="congrats">
              <p>
                ...
                <p style={{ marginTop: "5px", marginBottom: "0px" }}>
                  Use code <b>SE25</b> for 20% discount.
                </p>
              </p>
            </div>
